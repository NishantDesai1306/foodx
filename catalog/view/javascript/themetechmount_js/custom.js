...
$(document).ready(function() {
    ...
    $('.product_carousel,.sideproduct_carousel,.producttab_carousel,.brand_carousel,.blog-carousel,#ttmtestimonial_carousel,#ttmcat_carousel,.instagram_carousel, .gallery_album_carousel, .special_product_carousel').addClass('owl-carousel');
...
function specialcountdown() {
	$('.ttmtimer').each(function(){
		$(this).countdown($(this).attr('data-date'), function(event) {
			$(this).html(
				'<div class="clocktime days"><span class="clocktime-number">'+event.strftime('%D')+'</span><span class="clocktime-text">d</span></div><div class="clocktime hour"><span class="clocktime-number">'+event.strftime('%H')+'</span><span class="clocktime-text">h</span></div><div class="clocktime minute"><span class="clocktime-number">'+event.strftime('%M')+'</span><span class="clocktime-text">m</span></div><div class="clocktime second"><span class="clocktime-number">'+event.strftime('%S')+'</span><span class="clocktime-text">s</span></div>'
			);
		});
